...
public class TugasA extends JFrame {
        ...
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (nama.trim().isEmpty() || noTelp.trim().isEmpty() || alamat.trim().isEmpty()) {
                    JOptionPane.showMessageDialog(TugasA.this, "Form tidak boleh ada yang kosong!", "Warning",
                            JOptionPane.WARNING_MESSAGE);
                } else {
                    int confirmation = JOptionPane.showConfirmDialog(TugasA.this,
                    ...
                    if (confirmation == JOptionPane.YES_OPTION) {
                        ...
                        JOptionPane.showMessageDialog(TugasA.this, "Anda tidak memasukan data");
                    }
                }
            }
